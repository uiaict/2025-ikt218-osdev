 ...
 */
 ...
 #include "fat_fs.h"     // fat_lfn_entry_t, FAT_ATTR_LONG_NAME
 #include "fat_dir.h"    // *** ADDED: Include for FAT_MAX_LFN_CHARS definition ***
                                ...
                                int max_lfn_entries)
 {
     ...
     // Use FAT_MAX_LFN_CHARS defined in fat_dir.h (now included)
