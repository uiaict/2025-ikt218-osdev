...
void initIdt() {
    ...
    //main ship:  0x20 commands & 0x21 data
    //slave ship: 0xA0 commands & 0xA1 data
    ...
    setIdtGate(0, (uint32_t)isr0, 0x08, 0x8E); // 0x8E = 1000 1110 (P DPL 0 GateType), 0x08 = 0000 1000 (Segment selector)
