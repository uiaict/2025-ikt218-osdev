...
void save_painting(char painting1[], char painting2[]){
    savemenu_clear(0);
    savemenu_clear(1);
    disable_cursor();

    struct save_header *h1 = (struct save_header*)painting1;
    struct save_header *h2 = (struct save_header*)painting2;
...
void load_painting(char painting1[], char painting2[]){
    savemenu_clear(0);
    savemenu_clear(1);
    disable_cursor();
