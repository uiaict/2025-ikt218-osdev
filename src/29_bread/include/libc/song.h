...
static Note megalovania_theme[] = {
    {D4, 100}, {D4, 100}, {D4, 100}, {A3, 100}, {Gs3, 100}, {G3, 100},
    {F3, 100}, {D3, 100}, {F3, 100}, {G3, 150},

    {C4, 100}, {C4, 100}, {D4, 100}, {A3, 100}, {Gs3, 100}, {G3, 100},
    {F3, 100}, {D3, 100}, {F3, 100}, {G3, 150},

    {B3, 100}, {B3, 100}, {D4, 100}, {A3, 100}, {Gs3, 100}, {G3, 100},
    {F3, 100}, {D3, 100}, {F3, 100}, {G3, 150},

    {As3, 100}, {As3, 100}, {D4, 100}, {A3, 100}, {Gs3, 100}, {G3, 100},
    {F3, 100}, {D3, 100}, {F3, 100}, {G3, 150},
...
static Note jojo[] = {
    {G4, 150}, {A4, 150}, {B4, 150}, {D5, 300},
    {B4, 150}, {A4, 150}, {G4, 150}, {E4, 300},
    
    {G4, 150}, {A4, 150}, {B4, 150}, {D5, 300},
    {B4, 150}, {A4, 150}, {G4, 150}, {E4, 300},
    
    {Fs4, 150}, {G4, 150}, {A4, 150}, {C5, 300},
    {A4, 150}, {G4, 150}, {Fs4, 150}, {D4, 300},
    
    {R, 300}
};

static Note theme_of_laura_intro[] = {
    {E4, 200}, {D4, 200}, {B3, 200}, {A3, 200},
    {E4, 200}, {D4, 200}, {B3, 200}, {A3, 200},
    {G3, 200}, {E3, 400},
