...
#define HEAP_START 0x100000  // 1 MB heap start (same as in malloc.c)
// Heap settings
void* heap_base = (void*)0x100000; // Heap starts at 1MB
uint32_t heap_used = 0;
alloc_t alloc_table[1024]; // Allocation tracking table
...
void init_kernel_memory(uint32_t* kernel_end) {
    terminal_write("init_kernel_memory called\n");
