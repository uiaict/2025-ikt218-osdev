...
#define OFFSET_X ((VGA_WIDTH - SNAKE_BOARD_WIDTH) / 2)
#define OFFSET_Y ((VGA_HEIGHT - SNAKE_BOARD_HEIGHT) / 2)
#define TILE_IDX(x, y)  (((y)-1) * (SNAKE_BOARD_WIDTH - 2) + ((x)-1))
#define SCORE_ROW   (OFFSET_Y + SNAKE_BOARD_HEIGHT)
